...
function initSubGroups(map) {
    ...
    L.control.layers(null, null, { collapsed: true })
        .addOverlay(bulkSectionSubGroup, 'Ateliers de réparation collaboratifs'+getIconForControlLayer(convenienceIconUrl)+getIconForControlLayer(supermarketIconUrl))
