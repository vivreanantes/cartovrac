...
export var cacheBulkJsonPath = "cache_bulk_data_simplified.json?nocache=" + (new Date()).getTime();
export var itinerantShopsJsonPath = "itinerant.json?nocache=" + (new Date()).getTime();